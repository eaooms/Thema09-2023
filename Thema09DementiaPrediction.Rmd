...
```{r, echo=FALSE}
#Verschillende algo 
#met verschillende hyper parameters. zie lijst vorig jaar. 
#Verschillende datasets 
#met of zonder NAs 
#met of zonder log transformatie - even opzoeken 
#met of zonder standaardisatie/ normalisatie - voor het clusteren 
#verschillende selectie van atributen
